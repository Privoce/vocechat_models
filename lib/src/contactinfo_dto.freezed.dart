...
abstract class $ContactInfoDtoCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? status, int? createdAt, int? updatedAt});
}
...
class _$ContactInfoDtoImpl implements _ContactInfoDto {
  const _$ContactInfoDtoImpl({this.status, this.createdAt, this.updatedAt});
...
abstract class _ContactInfoDto implements ContactInfoDto {
  const factory _ContactInfoDto(
      {final String? status,
      final int? createdAt,
      final int? updatedAt}) = _$ContactInfoDtoImpl;
